...
<>
  ...
  <div className="container-fluid">
    <div className="row">
      <nav
        id="sidebarMenu"
        className="col-md-3 col-lg-2 d-md-block sidebar collapse" style={{backgroundColor: "black"}}
      >
        <div className="position-sticky pt-3 sidebar-sticky">
          ...
          <li className="nav-item">
            <a
              ...
              id="dashboardLink"
            >
              <span data-feather="home" className="align-text-bottom fw-bold " />
              <svg
          ...
          <li className="nav-item">
            <a className="nav-link" href="#" id="teachersLink">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#" id="lessonPlanLink">
          ...
          <li className="nav-item">
            <a className="nav-link" href="#" id="ordersLink">
