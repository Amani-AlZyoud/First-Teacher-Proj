    ...
    >
      ...
      >
       ...
       <tr key={row.id}>
          ...
          <td>{row.hw}</td>
          <td><button className="btn btn-white" id='createPlan' onClick={() => handleDelete(row.id)}>حذف</button></td>
          <td><button className="btn btn-white" id='createPlan' onClick={() => handleUpdate(row.id)}>تعديل</button></td>
        </tr></>})
        }
        </tbody>
      </table>
